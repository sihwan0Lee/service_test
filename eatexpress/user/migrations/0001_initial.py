    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=50, unique=True, verbose_name='전화번호')),
                ('address', models.CharField(blank=True, max_length=200, verbose_name='주소')),
                ('gender', models.CharField(blank=True, choices=[('M', '남성(Male)'), ('F', '여성(Female)')], max_length=10, verbose_name='성별')),
